...
INSERT INTO forms(action, form_id, name, method, page_id, action_id) VALUES('/send', 'anotherform', 'anotherform', 'POST', 1, 1);
INSERT INTO formfields(field_id, field_name, field_value, field_type, field_placeholder, form_id, action_id) VALUES('user_field', 'user_field', '','text', 'Initial Text',1, 1);
INSERT INTO formfields(field_id, field_name, field_value, field_type, field_placeholder, form_id, action_id) VALUES('email_field', 'email_field', '', 'text', 'Initial Text', 1, 1);
INSERT INTO formfields(field_id, field_name, field_value, field_type, field_placeholder, form_id, action_id) VALUES('hidden_field', 'read_field', '', 'hidden', 'Initial Text', 1, 1);
INSERT INTO formfields(field_id, field_name, field_value, field_type, field_placeholder, form_id, action_id) VALUES('user_field', 'user_field', '', 'text', 'Initial Text', 2, 1);
INSERT INTO formfields(field_id, field_name, field_value, field_type, field_placeholder, form_id, action_id) VALUES('email_field', 'email_field', '', 'text', 'Initial Text', 2, 1);
INSERT INTO formfields(field_id, field_name, field_value, field_type, field_placeholder, form_id, action_id) VALUES('hidden_field', 'read_field', '', 'hidden', 'Initial Text', 2, 1);
...
INSERT INTO rules (name, code, is_active) VALUES('detect', 'WORD test', TRUE);
INSERT INTO rules (name, code, is_active) VALUES('detect', 'WORD world', TRUE);
INSERT INTO rules (name, code, is_active) VALUES('block', 'WORD kill', TRUE);
...
INSERT INTO action_form_link(action_id, form_id) VALUES(1, 2);
INSERT INTO action_form_link(action_id, form_id) VALUES(2, 1);
INSERT INTO action_form_link(action_id, form_id) VALUES(2, 2);
...
INSERT INTO action_formfield_link(action_id, formfield_id) VALUES(2, 6);
...
INSERT INTO form_formfield_link(form_id, formfield_id) VALUES(2, 4);
INSERT INTO form_formfield_link(form_id, formfield_id) VALUES(2, 5);
INSERT INTO form_formfield_link(form_id, formfield_id) VALUES(2, 6);
